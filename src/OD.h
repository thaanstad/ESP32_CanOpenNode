...
********************************************************************************
    ...
    File info:
        ...
        Created:      11/23/2020 4:00:00 AM
        Created By:   trevorH
        Modified:     3/11/2023 1:10:55 PM
        Modified By:  

    Device Info:
        Vendor Name:  Arduino
        Vendor ID:    ArduinoVend
        Product Name: ArduinoProduct
        Product ID:   Arduino1

        Description:  ArduinoTestOD
*******************************************************************************/
...
typedef struct {
    ...
    uint32_t x6001_counterFromNode;
} OD_PERSIST_COMM_t;
...
#define OD_ENTRY_H6001_counterFromNode &OD->list[34]
